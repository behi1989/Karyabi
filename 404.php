...
<html lang="en">
  <head>
    ...
    <title>خطا پیدا نشدن صفحه</title>
 		...
 		<div class="row">
 			<div class="col-xs-12">
 				<div class="panel text-center">
 					<span><h1 class="wow fadeIn" data-wow-delay=".5s">404</h1></span>
 					<span><h2 class="wow fadeInDown" data-wow-delay="1s"><strong>Page Not Found...!</strong></h2></span>
					<span><h2 class="wow fadeInDown" data-wow-delay="1.5s"><strong>متاسفیم این صفحه وجود ندارد</strong></h2></span>
