...
?>																				
                   		<div>
							...
							if(!empty($rows['_avatar'])){
								echo "<img src='img/".$rows['_avatar']."' style='width: 50px;height: 50px;border-radius: 50%'>";
							}else{
								echo "<img src='img/no-user-image.gif' style='width: 50px;height: 50px;border-radius: 50%'>";
							}
							?>
                   			<?php echo $rows['_fname']; ?>
                   		</div>
                    	<a href="./userprofile.php" id="loginedit">ویرایش پنل کاربری</a>
